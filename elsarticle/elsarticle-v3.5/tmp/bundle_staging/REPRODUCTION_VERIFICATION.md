...
|---|---|
| `fig4.png` (Supplementary Fig. S1) | `07_analysis_and_figure_code/current_figure_sources/Fig4_Fig5_vision_split_final.py` (historical source name) |
| `fig5.png` (main Fig. 4) | `07_analysis_and_figure_code/current_figure_sources/Fig4_Fig5_vision_split_final.py` |
| `fig6.png` (main Fig. 5) | `07_analysis_and_figure_code/current_figure_sources/Fig6_completion_time_final.py` |
| `fig7.png` (main Fig. 6) | `07_analysis_and_figure_code/current_figure_sources/Fig7_workload_success_final.py` |
| `fig8.png` (main Fig. 7) | `07_analysis_and_figure_code/current_figure_sources/Fig8_paired_ce_standardized.py` |
| `fig9.png` (main Fig. 8) | `07_analysis_and_figure_code/current_figure_sources/Fig9_operator_object_standardized.py` |
