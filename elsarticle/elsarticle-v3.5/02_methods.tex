...
\caption{Experimental platform comprising the Omega.7 master device, Franka Panda robot and Franka Hand gripper, D435i camera, and control computer. The camera supplied 424 $\times$ 240 color images at 15 fps.}
\label{fig:1}
\end{figure}
...
\end{table*}
The camera window could be closed by pressing \texttt{q}. Table 3 describes the default software behavior; the window state was not included in the formal trial logs.
