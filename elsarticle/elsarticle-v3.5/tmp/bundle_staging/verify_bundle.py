#!/usr/bin/env python3
"""Read-only integrity and reproduction checks for the Mechatronics v5 archive."""
...
EXPECTED_SHA256 = {
    ...
    "05_vision_validation/vision_validation/results/vision_validation_per_image.csv": "6351ee1853360952a113b3efe0561f70e99cb70b98cc67c2c2a0c0d82bbcbaa7",
}
...
def main() -> None:
    ...
    vision = read_csv(ROOT / "05_vision_validation/vision_validation/results/vision_validation_per_image.csv")
