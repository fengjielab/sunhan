...
draw_box_scatter(ax, df, "duration_s", "Completion time (s)", "(a)", "Best (primary endpoint)", (15, 27))
plt.tight_layout()
plt.savefig("Fig5_a_completion_time.png", dpi=300)
plt.close()
print("Fig5(a) saved: Fig5_a_completion_time.png")