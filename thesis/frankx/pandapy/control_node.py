...
class ArmController:
    def __init__(self):
        ...
        self.pub = rospy.Publisher("/franka2/pose_control", PoseStamped, queue_size=1000)

    def arm_move(self):
        rate = rospy.Rate(30)

        ee_in_base_goal = np.array([0.55, 0.01,  0.3, 3.14072136e+00 ,-1.23602428e-03 , 1.73581766e-03])
