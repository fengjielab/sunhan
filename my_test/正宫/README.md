...
本目录是当前论文、分析证据和投稿材料的唯一实际存放位置。
旧路径 `F:\sun\sunhan\my_test\paper2_sci` 是指向本目录的兼容性目录联接。
...
- `01_primary_first_attempt_data/`：已按 SHA-256 与 `data` 核验后删除。
- `01_selected_data/`：已按 SHA-256 与 `data` 核验后删除。

完整删除记录见 `02_audit/cleanup_audit_20260826.json`。
