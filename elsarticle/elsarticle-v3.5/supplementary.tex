...
\midrule
 ...
 Haptic interface: $K_f$ & Lower $K_f$ $\rightarrow$ weaker rendered external-force cue; higher $K_f$ $\rightarrow$ stronger cue. & Acceptable Omega.7 response. & 0.2 / 0.5 / 0.7 \\
 Haptic interface: $d$ & Lower $d$ $\rightarrow$ greater sensitivity to small forces; higher $d$ $\rightarrow$ greater suppression of small signals. & Haptic-interface jitter and noise. & 0.3 / 0.4 / 0.5 N \\
