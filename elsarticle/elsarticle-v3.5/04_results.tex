...
In a post hoc sensitivity analysis, the C--E completion-time comparison was repeated using the 23 matched blocks in which both mode trials were successful. The mean paired difference in this subset was 1.80 s, and mode C was faster in 19 of the 23 blocks. The estimated difference was similar in magnitude to the 1.79-s primary estimate.
...
Across the 135 trials, 18 were classified as failures: 5, 6, 1, 3, and 3 in modes A--E, respectively. The observed failure outcomes involved object drops, observable slip, or visible damage according to the predefined criteria in Section~3.3. Table~\ref{tab:10} summarizes the mode-level failure counts and representative trial observations.
...
At the operator level, the mean paired differences $\Delta T=T_E-T_C$ were 1.66, 2.56, and 1.16 s for P01, P02, and P03, respectively. The corresponding operator-specific median [IQR] differences were 1.91 [0.60, 3.14], 2.63 [2.19, 3.34], and 1.60 [-0.53, 1.73] s, respectively. Mode C had a shorter completion time in 7/9, 9/9, and 6/9 matched task blocks for P01, P02, and P03, respectively. In the leave-one-operator-out sensitivity analysis, P01, P02, and P03 were excluded in turn. The mean paired differences in the remaining blocks were 1.86, 1.41, and 2.11 s, respectively, and all remained positive.
