...
from Fig7_workload_success_helper import (
    draw_nasa_panel,
    draw_success_panel,
    load_nasa_data,
...
def parse_args() -> argparse.Namespace:
    ...
    data_root = drawing_root / "Fig5_final_source_and_outputs" / "mnt" / "data" / "Fig5_final_package"
    parser = argparse.ArgumentParser(
        description="Generate Fig. 7: workload and observed task success across five modes."
    )
    parser.add_argument("--nasa-file", type=Path, default=data_root / "nasa.md")
    parser.add_argument("--output-dir", type=Path, default=drawing_root / "outputs" / "final_manuscript_figures")
