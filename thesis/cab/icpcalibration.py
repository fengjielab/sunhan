...
source = o3d.io.read_point_cloud("/home/sunh/thesis/cab/pc.ply")
mesh_frame = o3d.geometry.TriangleMesh.create_coordinate_frame(
        size= 0.1, origin=[0, 0,0])
source.paint_uniform_color([1, 0.706, 0])

o3d.visualization.draw_geometries([source, mesh_frame])



target=o3d.io.read_point_cloud('/home/sunh/thesis/cab/link0.ply',format="xyzrgb")
voxel_size = 0.015

#先用roslaunch calibrationpcdandmodel.launch 把读取到的点云拉到一个合适的初始位置，读取rosrun tf tf_echo /world /camera_link
translation =   [-0.068, -0.036, 0.385]
RPY =  [2.129, 0.465, -2.940]
