...
python3 my_test/capture_kfb_start_pose.py \
  --output my_test/正宫/23_kfb_timing_pilot/start_pose_v1.json \
...
python3 my_test/generate_kfb_timing_schedule.py \
  --output-dir my_test/正宫/23_kfb_timing_pilot/frozen_schedule_v8
```
...
python3 my_test/verify_kfb_timing_setup.py \
  --schedule-dir my_test/正宫/23_kfb_timing_pilot/frozen_schedule_v7 \
  --start-pose-file my_test/正宫/23_kfb_timing_pilot/start_pose_v1.json
```
...
python3 my_test/interactive_teleop.py \
  ...
  --trial-id ENG_E01_01 \
  --object-id FIXED_PAD \
  --kfb-oracle my_test/正宫/23_kfb_timing_pilot/frozen_schedule_v7/private_oracle/oracle.csv \
  --kfb-start-pose-file my_test/正宫/23_kfb_timing_pilot/start_pose_v1.json \
...
python3 my_test/analyze_kfb_timing.py unblind \
  ...
  --oracle my_test/正宫/23_kfb_timing_pilot/frozen_schedule_v7/private_oracle/oracle.csv \
