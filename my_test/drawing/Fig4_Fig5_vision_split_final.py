...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--data-file",
        type=Path,
        default=root / "data" / "vision_validation" / "results" / "vision_validation_per_image.csv",
    )
    parser.add_argument("--output-dir", type=Path, default=here / "outputs" / "restructured_figures")
