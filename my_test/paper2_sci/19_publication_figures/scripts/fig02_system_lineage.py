...
def write_qa(
    ...
    check("PNG resolution", png_info[2:4], "600 dpi", png_info[2] >= 599.0 and png_info[3] >= 599.0)
...
def main() -> None:
    ...
    report = write_qa(publication_root / "figure02_qa_report.json", counts, [lineage_path, participant_path], outputs, source_path)
